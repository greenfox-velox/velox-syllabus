...
def rotate(p, a):
    return (p[0] * math.cos(a) -
            p[1] * math.sin(a), p[1] * math.cos(a) +
            p[0] * math.sin(a))
...
n = 10
for i in range(30):
    w.create_line(300 + i * ((0.75 * (n ** 2)) ** 0.5), 300 - i * (n/2),
                  300, 0 + i*n, fill='#000000')
    w.create_line(300 - i * ((0.75 * (n ** 2)) ** 0.5), 300 - i * (n/2),
                  300, 0 + i*n, fill='#000000')
    w.create_line(300 + i * ((0.75 * (n ** 2)) ** 0.5), 300 + i * (n/2),
                  300, 600 - i*n, fill='#000000')
    w.create_line(300 - i * ((0.75 * (n ** 2)) ** 0.5), 300 + i * (n/2),
                  300, 600 - i*n, fill='#000000')
    w.create_line(300 + i * ((0.75 * (n ** 2)) ** 0.5), 300 - i * (n/2),
                  559.8 - i * ((0.75 * (n ** 2)) ** 0.5), 450 - i * (n/2),
                  fill='#000000')
    w.create_line(300 - i * ((0.75 * (n ** 2)) ** 0.5), 300 - i * (n/2),
                  40.2 + i * ((0.75 * (n ** 2)) ** 0.5), 450 -i * (n/2),
                  fill='#000000')
